...
export interface AUSDCInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "FAUCET_AMOUNT"
      | "FAUCET_COOLDOWN"
  ...
  decodeFunctionResult(functionFragment: "lastFaucet", data: BytesLike): Result;
...
export interface AUSDC extends BaseContract {
  connect(runner?: ContractRunner | null): AUSDC;
  waitForDeployment(): Promise<this>;

  interface: AUSDCInterface;
  ...
  lastFaucet: TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
